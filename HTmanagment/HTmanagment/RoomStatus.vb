...
Public Class RoomStatus
    ...
    Private Sub btn_update_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_update.Click
        Try
            ...
            Dim SelectCommand As MySqlCommand = New MySqlCommand("update  darstlabs.rooms set status='" & cmb_status.Text & "', bookStatus='" & cmb_bookstatus.Text & "' where roomNumber='" & txt_rmno.Text & "' ", mycon)
